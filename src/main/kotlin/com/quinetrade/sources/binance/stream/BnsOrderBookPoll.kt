...
import com.quintrade.sources.binance.stream.SymbolStreamSource
...
class BnsOrderBookPoll(val client: HttpClient) {
    ...
    suspend fun pollTrade() = coroutineScope {
    ...
    suspend fun pollSpread() = coroutineScope {
        var spreadStream = SymbolStreamSource()
        spreadStream.poll()
        launch {
